    ...
    <div class="box">
      ...
      <div class="more-choice" v-if="boxMoreShow">
        <div v-if="footerConf && footerConf.menu">
          <button v-for="menu in footerConf.menu">
            <span class="sItem" @click="backHome" v-if="menu.key == 'home'">回到首页</span>
            <span class="sItem" @click="showEva" v-if="menu.key == 'rate'">评价课程</span>
            <span class="sItem" @click="showRefund" v-if="menu.key == 'refund'">申请退款</span>
